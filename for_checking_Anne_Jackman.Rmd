...
- Duplication of paddock code means that looks up for soil testing recommned rats could be wrong.
- Cormer could have additional N strips (email to confirm but I dont know location of strips).
- This has been chnaged in Sean / Harms DB, I am now using the 23rd March DB.
- other sites include but I don't have inforamtion for these paddocks.
