...
selection_organisation <- "Vic Ind"

selection_Contact <- "Anne Jackman"
...
- Duplication of paddock code means that looks up for soil testing recommend rates could be wrong.
- Cormer could have additional N strips (email to confirm but I don't know location of strips).
- This has been changed in Sean / Harms DB, I am now using the 23rd March DB.
- other sites included but I don't have information for these paddocks.

333211	Vic	Wimmera	Independent	Anne	Taylor  Jims BlacK

333212	Vic	Wimmera	Independent	Anne	Taylor	Jims Black

333213	Vic	Wimmera	Independent	Anne	Taylor	Jims Black


333111 	Vic	S Mallee	Independent Anne 	McClelland 	Clovers E

333112	Vic	S Mallee	Independent	Anne	McClelland	Clovers E

333113	Vic	S Mallee	Independent	Anne	McClelland	Clovers E

333114	Vic	S Mallee	Independent	Anne	McClelland	Clovers E
...
```{r display results site 2, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
### Results
