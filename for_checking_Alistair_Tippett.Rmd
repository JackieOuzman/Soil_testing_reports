...
selection_Contact <- "Alistair_Tippett"
...
- Note that some zone are smaller than 1 ha and have limited option to increase the size.

- In Sunnside west zone 2 (Low - 311361) rate 0 doesnt have enough yield points to run t.test.
