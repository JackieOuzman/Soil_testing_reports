...
selection_Contact <- "Kris Dixon"

selection_Farmer <- "K&G Bird"
...
- More paddocks still go, data is reday just needs extracting:

- Kris Dixon	Marall     holdings	Channel
- Kris Dixon	Heighton	 Boort rd 
- Kris Dixon	Heighton	 Greys north
...
```{r display results site 3 page1, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
