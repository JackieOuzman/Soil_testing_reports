...
selection_Contact <- "Claire Gutsche"

selection_Farmer <- "Lister Trading"
...
paddock_done2020_display <- 
  ...
  dplyr::select(Paddock = paddock5_digits,
                ...
                `Dan's comments from reports`) %>% 
  dplyr::arrange(Farmer) 
paddock_done2020_display$`Paddock tested` <- gsub("`", "", paddock_done2020_display$`Paddock tested`)
...
paddock_details$`Paddock tested` <- gsub("`", "", paddock_details$`Paddock tested`)
