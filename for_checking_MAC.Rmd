...
selection_Farmer <- "MAC"
selection_Paddock <- "S4"
...
- No Alt strips for S4
- No Alt strips for N5N
- Yield column in the header file changed to t/ha
- I assume Granuloc Z is the same as Granulock Z
...
### paddock id details
site_name_1 <- paddock_done2020$`Paddock tested`[1]
site_name_2 <- paddock_done2020$`Paddock tested`[2]
#site_name_3 <- paddock_done2020$Farmer[3]
# site_name_4 <- paste0("^",paddock_done2020$paddock[4])
# site_name_5 <- paste0("^",paddock_done2020$paddock[5])
