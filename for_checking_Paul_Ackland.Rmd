...
selection_Contact <- "Paul Ackland"

#selection_Farmer <- "Limevale"
...
- Limevale	Big Bingo	
  pts only	no spatial or ratees	no yield
  
- Peninsula Farming	N03 	
  pts only	no spatial or ratees	no yield
  
- Peninsula Farming	MR Scrub	
  pts only	no spatial or ratees	no yield

- Torella Trading	Edwards 
  pts only	no spatial or ratees	no yield
  
- Torella Trading	Edwards 
  pts only	no spatial or ratees	no yield

- Peninsula Farming	Old Homestead			
- Torella Trading	Murrays House			
