...
Some sites will have limited analysis these include (I will update this soon)
-
...
site1 <- paste0((unique(paddock_done2020$Farmer)[1]),"/",
 ...
 site2 <- paste0((unique(paddock_done2020$Farmer)[]),"/",
...
```{r display results site 3, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
### Results
