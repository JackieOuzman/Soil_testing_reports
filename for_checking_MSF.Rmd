...
paddock_done2020_t <- paddock_done2020_t %>% 
  ...
  dplyr::mutate(paddock5_digits = substr(paddock_done2020_t$`Paddock code`,1,nchar(paddock_done2020_t$`Paddock code`)-1)) %>% 
  arrange(Farmer)
#select orgaiastion

selection_organisation <- "FSG"

selection_Contact <- "MSF/Frontier Farming"
#	MSF/Frontier Farming
...
These sites are very complicated to analyse, many have VR and strip and zone combinations that are not replicated.  

The rates of fertiliser applied is often a combination of starter and in season, which is part of the trial design, therefore it is included in the calculations of N / P content (unlike many other sites).

Some sites will have limited analysis these include:
- Hards	Francis
- Pole	Symes (the Fert rates are just a label)

- MSF/Frontier Farming Pole Gums; has very complicated set up. I am not sure my analsysis is capturing it.
...
site1 <- paste0((unique(paddock_done2020$Farmer)[1]),"/",
 ...
 site4 <- paste0((unique(paddock_done2020$Farmer)[2]),"/",
...
site7 <- paste0((unique(paddock_done2020$Farmer)[4]),"/",
                 ...
                 "/output/")
site8 <- paste0((unique(paddock_done2020$Farmer)[5]),"/",
                 (unique(paddock_done2020$`Paddock tested`)[8]),
                 "/output/")
site9 <- paste0((unique(paddock_done2020$Farmer)[5]),"/",
                 (unique(paddock_done2020$`Paddock tested`)[9]),
                 "/output/")
...
yld_trace_site9 <- list.files(path = paste0(Growers_folder, site9),pattern = "trace(.*)$", ignore.case = TRUE)
...
harvest_map_site9 <- list.files(path = paste0(Growers_folder, site9),pattern = "Final(.*)$", ignore.case = TRUE)
...
site_name_8 <- paste0("^",paddock_done2020$paddock[8])
site_name_9 <- paste0("^",paddock_done2020$paddock[9])
...
Paddock_selected_site9 <- paddock_done2020$paddock[9]
...
This is over 2 pages because this site has multiple zones.
...
```{r display results site 2 page2, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r display site 4, message=FALSE, warning=FALSE, include=FALSE}
...
```{r display results site 4 Page 1, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r display results site 4 Page 2, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}

# image_read(dir(png_folder, full.names=T, pattern=Paddock_selected_site4)) %>% 
#   image_rotate(90)


image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site4, ".+Pg2"))) %>% 
  image_rotate(90)
...
```
```{r display results site 5 page 2, echo=FALSE, message=FALSE, warning=FALSE}
...
image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site5, ".+Pg2"))) %>% 
  image_rotate(90)
...
```{r "display site 6", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r "display site 6 yld trace", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r display results site 6 page 1, echo=FALSE, message=FALSE, warning=FALSE}
...
```
```{r display results site 6 page 2, echo=FALSE, message=FALSE, warning=FALSE}
...
image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site6, ".+Pg2"))) %>% 
  image_rotate(90)
...
```{r display site 7, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r "display site 7 yld trace", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r "display results site 7 page 1", echo=FALSE, message=FALSE, warning=FALSE}
...
```
```{r "display results site 7 page 2", echo=FALSE, message=FALSE, warning=FALSE}
...
image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site7, ".+Pg2"))) %>% 
  image_rotate(90)
...
```{r display site 8, echo=FALSE, message=FALSE, warning=FALSE}


include_graphics(paste0(Growers_folder,site8,  harvest_map_site8))
```

### Yield trace


```{r "display site 8 yld trace", echo=FALSE, message=FALSE, warning=FALSE}



include_graphics(paste0(Growers_folder,site8,  yld_trace_site8))
```

### Results

```{r "display results site 8 page 1", echo=FALSE, message=FALSE, warning=FALSE}
...
image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site8, ".+Pg1"))) %>% 
  image_rotate(90)


```

```{r "display results site 8 page 2", echo=FALSE, message=FALSE, warning=FALSE}
...
image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site8, ".+Pg2"))) %>% 
  image_rotate(90)
...
```{r display site 9, echo=FALSE, message=FALSE, warning=FALSE}


include_graphics(paste0(Growers_folder,site9,  harvest_map_site9))
```

### Yield trace


```{r "display site 9 yld trace", echo=FALSE, message=FALSE, warning=FALSE}



include_graphics(paste0(Growers_folder,site9,  yld_trace_site9))
```

### Results

```{r "display results site 9 page 1", echo=FALSE, message=FALSE, warning=FALSE}
...
image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site9, ".+Pg1"))) %>% 
  image_rotate(90)


```

```{r "display results site 9 page 2", echo=FALSE, message=FALSE, warning=FALSE}
...
image_read(dir(png_folder, full.names=T, pattern = paste0(Paddock_selected_site9, ".+Pg2"))) %>% 
  image_rotate(90)
...
Note Gums has an extra strip that I won't get analysed.
...
numb_sites_paddock_ID <- c(Paddock_selected_site1, Paddock_selected_site2,
                           Paddock_selected_site3, 
                           #Paddock_selected_site4,
                           Paddock_selected_site5, Paddock_selected_site6,
                           Paddock_selected_site7, Paddock_selected_site8,
                           Paddock_selected_site9)
...
#! problem with this paddock
Paddock_selected_site6 <- 524102
...
dplyr::mutate(paddock5_digits = substr(recom_rateDB$Zone_ID,1,nchar(recom_rateDB$Zone_ID)-1)) 
