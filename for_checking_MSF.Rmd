...
NOTE FOR JACKIE
Look at line 66 in Prices (rec rate script) and see if I am selecting all zones!!
Matt 8 recom rates not working I have updated fert contnet.
Pole Gum having trouble with rec rates??
...
```{r display results site 5, echo=FALSE, message=FALSE, warning=FALSE}
