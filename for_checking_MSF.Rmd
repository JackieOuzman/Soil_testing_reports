...
```
```{r display results site 4 Page 2, echo=FALSE, message=FALSE, warning=FALSE}
...
paddock_details_join <- paddock_details_join %>%
  dplyr::filter(
      ...
      paddock5_digits == Paddock_selected_site5 |
      paddock5_digits == Paddock_selected_site6 |
      paddock5_digits == Paddock_selected_site7 
  )
