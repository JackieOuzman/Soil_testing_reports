...
#                               sheet = "T-test_done")
paddock_done2020_t<- read_excel("//casal-gw/C$/Users/ouz001/OneDrive - CSIRO/Soil_Testing_Project/paddock_done2020.xlsx", 
                              sheet = "T-test_done")
...
yld_trace_site2_N <- list.files(path = paste0(Growers_folder, site2),pattern = "N trace(.*)", ignore.case = TRUE)
yld_trace_site3_N <- list.files(path = paste0(Growers_folder, site3),pattern = "N trace(.*)", ignore.case = TRUE)
...
harvest_map_site2_N <- list.files(path = paste0(Growers_folder, site2),pattern = "N Final(.*)", ignore.case = TRUE)
harvest_map_site3_N <- list.files(path = paste0(Growers_folder, site3),pattern = "N Final(.*)", ignore.case = TRUE)
