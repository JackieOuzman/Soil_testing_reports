...
```{r display site 3 yld trace, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
### Yield trace
...
```{r rec rate comp high low plot, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
Rec_rate_comparison_table_lower_results <-                                        Rec_rate_comparison_table_lower_results_N

# Rec_rate_comparison_table_lower_rates <- rbind(Rec_rate_comparison_table_lower_rates,
#                                                 Rec_rate_comparison_table_lower_rates_N)
Rec_rate_comparison_table_lower_rates <-                                                 Rec_rate_comparison_table_lower_rates_N
