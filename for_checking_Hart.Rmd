...
# site1
# site2
site3 <- "Ottens/Paddock_17/output/"
site4 <- "Ottens/Pdk_6_North/output/"

site5 <-"Sommerville/Barn/output/"
site6 <- "Sommerville/Kellocks_Hut/output/"

site7 <-  "Williams/pdk42/output/"
site8 <-  "Williams/Pdk53/output/"
...
include_graphics("W:/value_soil_testing_prj/Yield_data/2020/FSG/Hart/Ottens/Paddock_17/output/Paddock-17_Final_map.jpg")
```
...
```{r display results site 6, echo=FALSE, message=FALSE, warning=FALSE}

image_read(dir(png_folder, full.names=T, pattern=site_name_6)) %>% 
  image_rotate(90)
...
```{r display results site 7, echo=FALSE, message=FALSE, warning=FALSE}

image_read(dir(png_folder, full.names=T, pattern=site_name_7)) %>% 
  image_rotate(90)
...
```{r display results site 8, echo=FALSE, message=FALSE, warning=FALSE}

image_read(dir(png_folder, full.names=T, pattern=site_name_8)) %>% 
  image_rotate(90)
