...
selection_Contact <- "Mick Faulkner"

selection_Farmer <- "Smith"
...
- Mick Faulkner	Faulkner	H8	 (Missing Strip locations - only have yield file)

- Mick Faulkner	Neal 	Hausler	 (Missing Strip locations - only have yield file)

- Mick Faulkner	Connell	R3	
...
recom_rateDB <- recom_rateDB %>%
  dplyr::filter(
    #paddock5_digits %in% numb_sites_paddock_ID) 
    paddock5_digits == numb_sites_paddock_ID) 
